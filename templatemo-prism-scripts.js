...
// Portfolio data for carousel
        ...
        const portfolioData = [
            {
                ...
                description: 'We deliver end-to-end digital solutions with refined interfaces, reliable data systems, scalable architecture and modern full-stack performance.',
                image: 'images/web1.avif',
                tech: ['Frontend', 'Backend', 'Database']
            },
            {
                id: 2,
                title: 'MATLAB & Engineering',
                description: 'We provide powerful computation, accurate modeling and tailored engineering tools for critical decisions.',
                image: 'images/signal.jpg',
                tech: ['Data Analysis', 'Mathematical Modeling']
            },
            {
                id: 3,
                title: 'Native',
                description: 'We deliver high-performance native applications with optimized system-level code, seamless device integration and scalable cross-platform execution.',
                image: 'images/native1.webp',
        ...
        const skillsData = [
            ...
            { name: 'Nuxt.js', icon: '🌀', level: 85, category: 'frontend' },
            ...
            { name: 'MongoDB', icon: '🍃', level: 90, category: 'database' },
            { name: 'PostgreSQL', icon: '🟣', level: 85, category: 'database' },
            { name: 'SQL Server', icon: '🏢', level: 90, category: 'database' },
            { name: 'MySQL', icon: '🐬', level: 90, category: 'database' },
            { name: 'C++', icon: '🟫', level: 92, category: 'native-software' },
            { name: 'C#', icon: '🐳', level: 85, category: 'native-software' },
            { name: 'Java', icon: '☕', level: 85, category: 'native-software' },
            { name: 'Arduino', icon: '🔧', level: 82, category: 'embedded' },
            { name: 'STM32', icon: '🟦', level: 87, category: 'embedded' },
            { name: 'RS485', icon: '🔌', level: 87, category: 'embedded' },
            { name: 'CAN', icon: '🚗', level: 87, category: 'embedded' },
            { name: 'Unreal Engine', icon: '🧊', level: 87, category: 'game-development' },
            { name: 'Unity', icon: '🟣', level: 87, category: 'game-development' },
        ...
        function updateCarousel() {
            ...
            items.forEach((item, index) => {
                ...
                if (absOffset === 0) {
                    ...
                    // Hidden items (behind)
                    item.style.transform = 'translate(-50%, -50%) translateZ(-800px) scale(0.5)';
